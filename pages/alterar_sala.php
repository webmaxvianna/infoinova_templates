        ...
        <div class="col-md-10 offset-md-1">
          <div class="alert alert-danger alert-dismissible">
            <div class="lead">
              ...
              Não foi possível alterar informações da sala. Tente novamente.
            </div>
          </div>               
        </div>
      </div>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12 form-group">
                      ...
                      <input type="text" name="nome" id="nome" required class="form-control" autocomplete="off" value="Anfiteatro"/>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-3 form-group">
                      ...
                      <select required name="localizacao" id="localizacao" class="form-control" >
                        ...
                        <option value="BLOCO A" selected>BLOCO A</option>
                    ...
                    <div class="col-md-3 form-group">
                      ...
                      <input type="number" min="0" name="capacidade" required id="capacidade" class="form-control" autocomplete="off" value="80"/>
                    </div>
                    <div class="col-md-3 form-group">
                      <label>Valor por periodo (R$)</label>
                      <input type="text" name="valPeriodo" id="valPeriodo" pattern="[0-9.,]+" class="form-control" autocomplete="off" value="200,00"/>
                    </div>
                    <div class="col-md-3 form-group">
                  ...
                  <div class="row">
                    <div class="col-md-7">
                      ...
                      <div class="row">
                        <div class="col-md-6 form-group">
                          <label>Mesas</label>
                          <input type="number" min="0" name="mesas" id="mesas" value="2" class="form-control"  autocomplete="off"/>
                        </div>
                        <div class="col-md-6 form-group">
                          <label>Cadeiras</label>
                          <input type="number" min="0" name="cadeiras" id="cadeiras" value="80" class="form-control"  autocomplete="off"/>
                        </div>
                      </div>
                    ...
                    <div class="col-md-4 offset-md-1">
                        <div class="form-group">
                          <div class="custom-control custom-switch">
                            <input type="checkbox" checked class="checkbox custom-control-input" id="climatizado" name="climatizado">
                        ...
                        <div class="form-group">
                          <div class="custom-control custom-switch">
                            <input type="checkbox" checked class="checkbox custom-control-input" id="projetor" name="projetor">
