                    ...
                    <div class="col-md-12">
                      ...
                      <div class="row">
                        <div class="form-group col-md-2">
                          <label>CEP</label>
                          <input required enabled pattern="[0-9]{5}-[0-9]{3}" minlength="9" maxlength="9" onpaste="consultaCEP(this.value)" onchange="consultaCEP(this.value)" type="text" id="cep" name="cep" class="form-control">
                        </div>
