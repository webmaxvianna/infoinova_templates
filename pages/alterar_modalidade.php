                    ...
                    <div class="col-md-12">
                      ...
                      <div class="row">
                        <div class="form-group col-sm-2">
                          <label>Código</label>
                          <input type="text" id="codigo" name="codigo" class="form-control" value="3.1">
                        </div>
                        <div class="form-group col-sm-10 ">
                            <label>Nome</label>
                          <input type="text" id="nome" name="nome" class="form-control" value="Escritório Virtual Individual">
                        </div>
                        <div class="form-group col-sm-4">
                          <label>Edital</label>
                          <input type="text" id="edital" name="edital" class="form-control" value="Edital">
                        </div>
                        <div class="form-group col-sm-4">
                          <label>Valor Mensal (R$)</label>
                          <input type="text" id="valor_mensal" name="valor_mensal" class="form-control" value="0">
                        </div>
                        <div class="form-group col-sm-4">
                          <label>Valor Anual (R$)</label>
                          <input type="text" id="valor_anual" name="valor_anual" class="form-control" value="0">
                        </div>                         
                        <div class="form-group col-sm-12">
                          <label>Descrição</label>
                          <input type="text" id="descricao" name="descricao" class="form-control" value="Escritório virutal individual">
                        </div>
                      </div>
